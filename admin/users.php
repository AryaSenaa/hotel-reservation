  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Data Users</small></h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <?php } else { ?>
                            <span class="badge bg-info">Resepsionis</span>
                        <?php } ?>
                      </td>
                      <td>
                        <a href="edit_user.php?id=<?php echo $d['id']; ?>" class="btn btn-warning">Edit</a>
                        <a href="hapus_user.php?id=<?php echo $d['id']; ?>" class="btn btn-danger">Hapus</a>
                      </td>
                    </tr>
                    <?php } ?>
                  </tbody>
