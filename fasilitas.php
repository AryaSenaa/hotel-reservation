  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Fasilitas<small> Hotel Hebat</small></h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                  ...
                  <div class="carousel-inner">
                    <div class="carousel-item active">
                      <img class="d-block w-100" src="assets/gambar/g6.jpg" alt="First slide" height="450">
                    </div>
                    <div class="carousel-item">
                      <img class="d-block w-100" src="assets/gambar/g7.jpg" alt="Second slide" height="450">
                    </div>
                    <div class="carousel-item">
                      <img class="d-block w-100" src="assets/gambar/g8.jpg" alt="Third slide" height="450">
                    </div>
                  </div>
            ...
            ?>
              <div class="col-md-4">
                <div class="card card-outline">
                  <!-- /.card-header -->
                  <div class="card-body">
                    <img class="d-block w-100" height="200" src="admin/gambar/<?php echo $row['gambar']; ?>">
                  </div>
                  <!-- /.card-body -->
                </div>
                <!-- /.card -->
